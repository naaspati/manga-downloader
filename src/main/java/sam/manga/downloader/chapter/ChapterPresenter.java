...
import static sam.manga.downloader.extra.Utils.open;
...
import static sam.manga.downloader.extra.Utils.*;
...
public class ChapterPresenter extends VBox {
    ...
    public ChapterPresenter(Chapter chapter) {
        ...
        FxClassHelper.setClass(this, "downloadable-chapter", "v-box");
    ...
    private static Image REFRESH_ICON = new Image(getImageInputStream("repeat-1.png"), ICON_SIZE, 0, true, true);
    private static Image OPEN_DIR_ICON = new Image(getImageInputStream("folder-11.png"), ICON_SIZE, 0, true, true);
    private static Image COPY_TEXT_ICON = new Image(getImageInputStream("send.png"), ICON_SIZE, 0, true, true);
    ...
    private void addErrorPane() {
        if(errorTable == null){
            ...
            openDirButton.setOnAction(e -> open(chapter.getSavePath().toUri().toString()));
    ...
    public boolean cancel() {
        ...
        if(b && getCompletedCount() != chapter.size())
